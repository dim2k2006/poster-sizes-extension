...
const sizes: Sizes = {
  landscape: {
    ...
    1: { width: 70, height: 50 },
    2: { width: 61, height: 43 },
    3: { width: 50, height: 40 },
    4: { width: 40, height: 30 },
    5: { width: 30, height: 21 },
    6: { width: 30, height: 20 },
    7: { width: 29.9, height: 20 },
    8: { width: 15, height: 10 },
    9: { width: 14.8, height: 10.5 },
  },
  portrait: {
    0: { width: 50, height: 70 },
    1: { width: 40, height: 50 },
    2: { width: 30, height: 40 },
    3: { width: 30, height: 41 },
    4: { width: 21, height: 30 },
    5: { width: 10.5, height: 14.8 },
    6: { width: 38, height: 57 },
