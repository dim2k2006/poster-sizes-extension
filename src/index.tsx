...
const sizes: Sizes = {
  ...
  portrait: {
    ...
    1: { width: 50, height: 70 },
    2: { width: 40, height: 50 },
    3: { width: 30, height: 40 },
    4: { width: 30, height: 41 },
    5: { width: 21, height: 30 },
    6: { width: 10.5, height: 14.8 },
    7: { width: 38, height: 57 },
    8: { width: 38, height: 52 },
    9: { width: 29.7, height: 42 },
    10: { width: 30, height: 130 },
    11: { width: 10, height: 15 },
    12: { width: 10, height: 16.5 },
    13: { width: 8, height: 10 },
    14: { width: 5, height: 10 },
  },
  square: {
